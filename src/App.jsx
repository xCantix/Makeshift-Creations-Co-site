...
function SectionHeader({ eyebrow, title, text, dark = true }) {
  return (
    <div className="mx-auto mb-12 max-w-3xl text-center">
      <p className={`mb-3 text-sm font-bold uppercase tracking-[0.3em] ${dark ? "text-white/45" : "text-neutral-400"}`}>{eyebrow}</p>
      <h2 className={`text-3xl font-black tracking-tight md:text-5xl ${dark ? "text-white" : "text-neutral-950"}`}>{title}</h2>
      {text && <p className={`mt-4 text-lg leading-8 ${dark ? "text-white/60" : "text-neutral-600"}`}>{text}</p>}
    </div>
  );
}
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      ...
      {currentPage === "creations" && (
        <section id="creations" className="border-t border-white/10 px-5 py-24 pt-36">
      ...
      {currentPage === "services" && (
        <section id="services" className="bg-white px-5 py-24 pt-36 text-neutral-950">
          <div className="mx-auto max-w-7xl">
            <SectionHeader dark={false} eyebrow="Services" title="Whatever it is, make it stand out." text="Custom stickers, vinyl decals, logo design, 3D prints, and vinyl-pressed shirts for individuals, makers, and small businesses." />
      ...
      {currentPage === "about" && (
        <section id="about" className="border-y border-white/10 px-5 py-24 pt-36">
      ...
      {currentPage === "contact" && (
        <section id="contact" className="px-5 py-24 pt-36">
